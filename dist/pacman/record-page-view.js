...
var _default = function _default(d, w, n, pacman) {
  var vp = "hidden";
  ...
  var r = function r(f) {
    try {
      ...
      return _typeof(o) == _typeof(true) ? +o : o;
    } catch (e) {
      return null;
    }
  },
    ...
    lz: r(function () {
      return n.languages.join(" ").toLowerCase();
    }),
    vw: r(function () {
      return re.clientWidth || w.innerWidth;
    }),
    vh: r(function () {
      return re.clientHeight || w.innerHeight;
    }),
    sw: r(function () {
    ...
    ll: r(function () {
      return n.languages[0].substr(0, 2) !== n.language.substr(0, 2);
    }),
    lr: r(function () {
      return w.screen.width < w.screen.availWidth || w.screen.height < w.screen.availHeight;
    }),
    lo: r(function () {
      var cpu = n.oscpu,
          p = n.platform.toLowerCase();
      if (ua.indexOf("windows phone") >= 0 || ua.indexOf("win") >= 0) return null;
      if (ua.indexOf("android") >= 0) return typeof n.plugins === "undefined" || p.indexOf("win") >= 0 || p.indexOf("mac") >= 0 || p.indexOf("ipad") >= 0 || p.indexOf("ipod") >= 0 || p.indexOf("iphone") >= 0;
      if (ua.indexOf("linux") >= 0) return null;
      if (ua.indexOf("iphone") >= 0 || ua.indexOf("ipad") >= 0) return typeof n.plugins === "undefined" || p.indexOf("win") >= 0 || p.indexOf("linux") >= 0 || p.indexOf("android") >= 0 || p.indexOf("pike") >= 0;
      return null;
    }),
    lb: r(function () {
      var ps = n.productSub,
...
(function () {
  ...
  reactHotLoader.register(requestNumber, "requestNumber", "/Users/homam/dev/sam/os/ouisys-clients/src/pacman/record-page-view.ts");
  reactHotLoader.register(_default, "default", "/Users/homam/dev/sam/os/ouisys-clients/src/pacman/record-page-view.ts");
  leaveModule(module);
})();
